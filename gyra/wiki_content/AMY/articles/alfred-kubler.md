...
authors=Unknown
template=character
role=Lead Researcher / Botanist / Scientific Cohort — transformed into Relbuk Derfla
age=205 (born 1820; trapped in Ingersole 1892; transformed over subsequent decades)
height=~1.75m / 5'9" (pre-transformation; crow form dimensions unrecorded)
status=Transformed — now exists as [Relbuk Derfla](relbuk-derfla.md) in the City of Quitters
birth_date=1820
faction=Scientific Cohort (former) / City of Quitters
voice_actor=?
first_appearance=Referenced in lore; physically encountered as Relbuk in Chapter 5
relationships
[Eila Bartlett](eila-bartlett.md) — university professor and mentor; Kubler was Eila's student
[Albert Ross](albert-ross.md) — employer and patron; Ross financed the excavation of Ross Valley
[Dr. Elizabeth Blueth Needham](dr-elizabeth-blueth-needham.md) — scientific cohort colleague
[Sam Bernal](sam-bernal.md) — scientific cohort colleague
[Relbuk Derfla](relbuk-derfla.md) — Kubler's transformed identity; his name reversed
...
At 246 years old, Kubler's own [Kubler](the-kubler.md) exposure has produced results. He is in the [Ingersole Mines](ingersole-caverns.md), lying down. At some point he attempted to use the organism's transformative properties to make himself more birdlike, with the goal of eventually flying away. He failed at the flying part. He is dressed as a crow. He is lying in the dark in the mines, in a sorry state. He does not appear to mind.

## Connection to Amy

Kubler is responsible for [Amy](amelia-amy-loevinger.md)'s current existence. When [Barret](barret-aricson.md) found her after her death, it was the [Kubler](the-kubler.md)'s presence that kept her from being simply gone, and Kubler's knowledge that allowed her to be reassembled. She does not know the full extent of this in [Chapter 1](chapter-1.md). By [Chapter 5](chapter-5.md), it has been established thoroughly.
