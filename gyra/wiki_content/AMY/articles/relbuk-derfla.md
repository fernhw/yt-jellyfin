...
age=205 (born 1820 as Alfred Kubler; transformed after 1892 mine sealing)
height=Crow form; dimensions not recorded
status=Active — City of Quitters (Ingersole Caverns)
birth_date=1820 (as Alfred Kubler)
faction=City of Quitters
voice_actor=?
first_appearance=Chapter 5
relationships
[Alfred Kubler](alfred-kubler.md) — Relbuk's original identity; his name reversed and his shape gone
[Amelia Loevinger](amelia-amy-loevinger.md) — Chapter 5 encounter; Amy unknowingly reopened the Ingersole that has kept him trapped
[Emerette of the Deep](emerette-of-the-deep.md) — the creature Kubler's experiments created; the reason he was sealed in
