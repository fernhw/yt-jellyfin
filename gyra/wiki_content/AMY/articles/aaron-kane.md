...
authors=Unknown
template=character
role=Chief Engineer (1848–~1893) → One-Man Theater Company / Distributed Puppet Master
age=200 (born 1825)
height=Original: 1.85m / 6'1" | Current: ~1.57m / 5'2" puppet-form; distributed across ~40 bodies
status=Active — Theater of Dreams; has not left it in over a century
birth_date=1825
faction=Ross Hotel / Theater of Dreams
voice_actor=(EN Wishlist) Mark Hamill
first_appearance=Chapter 3
relationships
[Albert Ross](albert-ross.md) — original employer; Kane built the VIP elevator shaft to the Ingersole during construction
[The Puppets](the-puppets.md) — extensions of Kane's own body; tendons and muscle tissue removed and animated
[Amelia Loevinger](amelia-amy-loevinger.md) — Chapter 3 encounter; Amy and Kane flee his own puppet audience

[HERO]


[MAIN_SECTION]
is the one-man show. owner, author, writer, director, producer, and performer of the Theater of Dreams. With his showmanship and expert storytelling, he's the best show the theater has ever seen, and also the only show the theater has ever seen.
...
In the ending the game considers good for Kane's arc, the miners of [Ingersole](ingersole-caverns.md) find what he built and embrace his technology as art. Kane, distributed across his puppets, scattered across the lower hotel, is found by people who understand what he made. He wanted to be left alone. He is, instead, appreciated. The game does not tell you whether he considers this an improvement.
