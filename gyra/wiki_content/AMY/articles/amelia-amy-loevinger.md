...
[SECONDARY]
## Overview
Amy is fourteen years old, standing 1.3 meters tall with brown hair and a clean, androgynous-but-distinctly-female design built for readability against the hotel's ornate decay. She is voiced by **Lizzie Freeman**. She is the seventh maid of the Albert Ross Hotel.

She is not supposed to be here. She is also, though the game will never say so directly, trying to die.
...
Amy is genuinely sweet. Not naive, not performing; she is kind by instinct, patient with the strange and broken people she meets, and makes friends easily in a hotel where that should be impossible. She is not afraid of dying to an unusual degree. She is hiding something from everyone, including herself, and she is not very good at talking around it, so instead she simply doesn't bring it up.
...
## The Sin System & Amy's Body

Amy was physically dismembered before the events of the game and reassembled by the hotel's [Kubler](the-kubler.md)-sustained repair process. The marks of this are on her, not always visible, but present. The game's **[Sin System](sin-system.md)** adds to them: bad-path solutions to character puzzles leave physical marks on Amy that persist for the rest of the run. Soot from setting [Sam](sam-bernal.md)'s lamp on fire. Other marks from other choices. These are also the game's [achievement](achievements.md) triggers for taking the cruel path.
