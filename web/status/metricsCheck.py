...
snap = {
    ...
    "disk_io":   [{"n": d["name"], "l": d.get("label", d["name"]), "r": round(d["read_bps"]), "w": round(d["write_bps"]), "mr": d.get("max_r", 0), "mw": d.get("max_w", 0), "ri": round(d.get("read_iops", 0)), "wi": round(d.get("write_iops", 0)), "mir": d.get("max_iops_r", 0), "miw": d.get("max_iops_w", 0)} for d in data.get("disk_io", [])],
